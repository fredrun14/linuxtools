...
class TestLinuxFileManager:
    ...
    def _make_manager(self) -> tuple[LinuxFileManager, MagicMock]:
        """Crée un manager avec un logger mock."""
        logger = MagicMock()
        return LinuxFileManager(logger), logger

    def test_create_file_succes(self, tmp_path: Path) -> None:
    ...
    def test_create_file_echec(self) -> None:
    ...
    def test_file_exists_retourne_true(self, tmp_path: Path) -> None:
    ...
    def test_file_exists_retourne_false(self, tmp_path: Path) -> None:
    ...
    def test_read_file_succes(self, tmp_path: Path) -> None:
    ...
    def test_read_file_echec_fichier_inexistant(self) -> None:
    ...
    def test_delete_file_succes(self, tmp_path: Path) -> None:
    ...
    def test_delete_file_echec_inexistant(self) -> None:
        """Retourne False si le fichier n'existe pas."""
        manager, logger = self._make_manager()
    ...
    def test_create_file_refuse_symlink(self, tmp_path: Path) -> None:
    ...
    def test_create_file_fixe_permissions_0644(self, tmp_path: Path) -> None:
...
class TestLinuxFileBackup:
    ...
    def _make_backup(self) -> tuple[LinuxFileBackup, MagicMock]:
        """Crée un gestionnaire de sauvegarde avec un logger mock."""
        logger = MagicMock()
        return LinuxFileBackup(logger), logger

    def test_backup_succes(self, tmp_path: Path) -> None:
    ...
    def test_backup_source_absente_retourne_false(self, tmp_path: Path) -> None:
    ...
    def test_backup_retourne_true_si_succes(self, tmp_path: Path) -> None:
    ...
    def test_backup_refuse_symlink_destination(self, tmp_path: Path) -> None:
    ...
    def test_backup_erreur_destination_invalide(self, tmp_path: Path) -> None:
    ...
    def test_restore_succes(self, tmp_path: Path) -> None:
    ...
    def test_restore_backup_inexistant(self, tmp_path: Path) -> None:
    ...
    def test_restore_exception_oserror(self, tmp_path: Path) -> None:
    ...
    def test_restore_refuse_symlink_destination(self, tmp_path: Path) -> None:
    ...
    def test_backup_refuse_symlink_source(self, tmp_path: Path) -> None:
    ...
    def test_backup_sans_logger(self, tmp_path: Path) -> None:
    ...
    def test_restore_sans_logger(self, tmp_path: Path) -> None:
...
class TestCopytreeSecure:
    ...
    def test_copie_arbre_complet(self, tmp_path: Path) -> None:
    ...
    def test_fichiers_ont_permissions_0644(self, tmp_path: Path) -> None:
    ...
    def test_repertoires_ont_permissions_0755(self, tmp_path: Path) -> None:
    ...
    def test_dirs_exist_ok_false_leve_FileExistsError(self, tmp_path: Path) -> None:
    ...
    def test_dirs_exist_ok_true_fusionne(self, tmp_path: Path) -> None:
    ...
    def test_ignore_filtre_fichiers(self, tmp_path: Path) -> None:
    ...
    def test_ignore_filtre_repertoires(self, tmp_path: Path) -> None:
    ...
    def test_symlinks_ignores_silencieusement(self, tmp_path: Path) -> None:
    ...
    def test_source_absente_leve_FileNotFoundError(self, tmp_path: Path) -> None:
    ...
    def test_source_symlink_leve_OSError(self, tmp_path: Path) -> None:
    ...
    def test_retourne_path_destination(self, tmp_path: Path) -> None:
        """Retourne Path(dst)."""
        src = tmp_path / "src"
        src.mkdir()
        dst = tmp_path / "dst"
    ...
    def test_follow_symlinks_copie_fichier_cible(self, tmp_path: Path) -> None:
    ...
    def test_follow_symlinks_copie_repertoire_cible(self, tmp_path: Path) -> None:
    ...
    def test_follow_symlinks_false_ignore_symlinks(self, tmp_path: Path) -> None:
    ...
    def test_follow_symlinks_symlink_mort_ignore(self, tmp_path: Path) -> None:
