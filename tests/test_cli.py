...
class TestCliCommand:
    ...
    def test_register_enregistre_la_commande_dans_subparsers(self):
    ...
    def test_execute_est_appele_avec_le_namespace_correct(self):
    ...
    def test_concrete_command_sans_register_ne_peut_etre_instanciee(self):
    ...
    def test_concrete_command_sans_execute_ne_peut_etre_instanciee(self):
...
class TestCliApplication:
    ...
    def test_run_avec_liste_vide_leve_system_exit(self, monkeypatch):
    ...
    def test_run_flag_avec_valeur_par_defaut(self, monkeypatch):
    ...
    def test_run_toutes_les_commandes_sont_enregistrees(self, monkeypatch):
