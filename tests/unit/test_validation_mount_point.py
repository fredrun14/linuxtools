...
class TestPathCheckerMountPoint:
    ...
    def test_validate_chemin_direct_mount(self, tmp_path: Path) -> None:
    ...
    def test_validate_leve_si_aucun_mount(self, tmp_path: Path) -> None:
    ...
    def test_message_contient_chemin(self, tmp_path: Path) -> None:
    ...
    def test_nearest_mount_remonte_au_parent(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_accepte_str_en_entree(self, tmp_path: Path) -> None:
